...
<div className="image-map-container roborio-map">
    <img
        src={useBaseUrl('img/images/robotcontroller/roborio/roborio2x.webp')}
        alt="RoboRIO"
...
<div>
    <img
        src={useBaseUrl("img/images/robotcontroller/roborio/roborioteamnumbersetter.webp")}
...
<iframe
    src={useBaseUrl("img/images/robotcontroller/roborio/roborio_2_0_embedded_controller_for_frc_specifications_2026-05-15-02-12-22.pdf")}
    width="100%"
    height="800"
    style={{ border: "none" }}
/>