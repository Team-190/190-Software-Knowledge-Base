...
* Environmental impact statement: a rough, good-faith estimate of the resource cost of the AI usage disclosed above,
  ...
  | Metric          | Estimate                        | Context                                                     | Source                                                                                                                                                                                     |
    |-----------------|---------------------------------|-------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  | Session         | 1:10 hr claude-sonnet-5 session | N/A                                                         | N/A, directly observed                                                                                                                                                                     |
  | Input tokens    | ~9.1k                           | Roughly a 11-page book you skimmed/read                     | https://help-lb.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them, https://theplanettools.ai/blog/ai-model-pricing-explained-input-output-cached-tokens-2026            |
  | Output tokens   | ~174.5k                         | Roughly a 217-page book you wrote                           | https://help-lb.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them, https://theplanettools.ai/blog/ai-model-pricing-explained-input-output-cached-tokens-2026            |
  | Electricity     | ~2.291 KWh                      | About 12.6% of US average daily household power consumption | (Input + output tokens) × published per-token energy estimates https://tokenomy.ai/tools/energy-usage-estimator, https://nrgcleanpower.com/learning-center/how-many-kwh-per-day-is-normal/ |
  | CO2e            | ~0.903 Kg                       | About driving a gas car 2.3 miles                           | (Input + output tokens) × regional grid carbon intensity https://tokenomy.ai/tools/energy-usage-estimator                                                                                  |
  | Water (cooling) | ~11.18 L                        | ~22.36 Aquifina waterbottles                                | (Input + output tokens) × data center water-usage-effectiveness https://tokenomy.ai/tools/energy-usage-estimator                                                                           |
  | API cost        | ~$11.16                         | ~$3.00 less than 2 Daves Hot Chicken Sliders                | (Input + output tokens) × the provider's published per-token input/output pricing for the model used                                                                                       |
