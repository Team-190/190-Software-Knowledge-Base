    ...
    tutorialSidebar: [
        ...
        },
        {
            ...
            items: [
                ...
                'training/xrp_java_course/ITS_CLASS_TIME',
                'training/xrp_java_course/ON_THE_STRAIGHT_AND_NARROW',
                'training/xrp_java_course/ROBOTS_HAVE_ECHOLOCATION',
                'training/xrp_java_course/TURNING_POINT',
                'training/xrp_java_course/KEEPING_A_SCHEDULE'
            ],
        },
    ],
};
